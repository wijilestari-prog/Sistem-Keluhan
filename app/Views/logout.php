...
<body class="authentication-bg">
        ...
        <div class="container">
                                    ...
                                    <div class="p-4 my-auto">
                                        <div class="my-auto">
                                            ...
                                            <div class="logout-icon m-auto">
                                                ...
                                                <img src="<?= base_url(). 'assets/images/svg/shield.gif' ?>" alt="" class="img-fluid">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <p class="text-dark-emphasis">Back To <a href="/login"
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark-emphasis">
            <script>document.write(new Date().getFullYear())</script> © Lampung Cerdas - Theme by Techzaa
        </span>
    </footer>
    <!-- Vendor js -->
